							...
							<div class="card" style="width:24rem;">
								...
								<div class="card-body">
									...
									<form class="cart-form" action="welcome-user.php" method="post">
										...
										<button name="addCartBtn" id="addCartBtnid" class="btn btn-sm btn-info pull-right" onclick="fun()">Add</button>
									</form>	
									<div class="card-text" style="margin-top: 10px;"><?php echo 'Rs. '.$row['item_price']; ?></div>
								</div>
							</div>
						</div>
					<?php } ?>
